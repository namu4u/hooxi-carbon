...
const FAQ_ITEMS = [
  ...
  {
    q: "KOC 발급까지 얼마나 걸리나요?",
    a: "계약 체결 후 ①타당성 평가(방법론 검토, 환경부 30일 이내) → ②모니터링 보고서 작성 → ③제3자 검증 → ④감축량 인증 심사(30일 이내) → ⑤KOC 발급·시장 매각 순으로 진행되며, 통상 6~12개월이 소요됩니다. 단, 2021~2022년 설치 설비처럼 모니터링 기간이 이미 경과한 경우 일부 단계가 단축될 수 있습니다. 모든 행정 절차는 후시파트너스가 전담하며, 고객 포털에서 단계별 진행 현황을 실시간으로 확인하실 수 있습니다.",
  },
  {
